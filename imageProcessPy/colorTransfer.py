...
def show_image(image, width = 300, title = 'result'):
...
# Usage: python3 xxx.py --source images/ocean_sunset.jpg --target images/ocean_day.jpg
if __name__ == '__main__':
	# construct the argument parser and parse the arguments
	ap = argparse.ArgumentParser()
	ap.add_argument("-s", "--source", default='./images/autumn.jpg',
		help = "Path to the source image")
	ap.add_argument("-t", "--target", default='./images/storm.jpg',
	...
	ap.add_argument("-p", "--preservePaper", type = str2bool, default = 'f',
	...
	show_image(transfer, 1080, "Transfer")
	cv2.waitKey(3000)
