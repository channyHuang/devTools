...
# np.random.seed((int)(time.time() // 1024))
# # 生成服从均匀分布的随机数据，范围设定在0到100之间
# data = np.random.uniform(352, 866, num_bars)

# # 创建条形图
# plt.bar(range(num_bars), data)
# plt.xlabel('Bar Index')
# plt.ylabel('Value')
# plt.title('Bar Chart with Uniformly Distributed Random Data')
# plt.show()
#!/usr/bin/env python
'''
===============================================================================
